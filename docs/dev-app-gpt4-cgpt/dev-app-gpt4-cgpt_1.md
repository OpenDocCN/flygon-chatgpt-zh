...
OpenAI 引入了在 GPT-4 中使用插件的功能。正如我们将在[第五章](ch05.html#advancing_llm_capabilities_with_the_langchain_fram)中看到的，这些工具允许你为 LLM 添加额外的功能。其中一个工具是一个计算器，可以帮助 GPT 正确回答这类问题。
