...
![图片](img/image_rsrc129.jpg)

它给出了：

![图片](img/image_rsrc12A.jpg)
...
![图片](img/image_rsrc12B.jpg)

音频文件将被保存为类似 output.mp3 的文件：

![图片](img/image_rsrc12C.jpg)
...
![图片](img/image_rsrc12D.jpg)

它告诉我们使用 pyttsx3 库来处理不同的语言和口音，并提供了更新的脚本：

![图片](img/image_rsrc12E.jpg)

让我们复制粘贴代码并运行它：

![图片](img/image_rsrc12F.jpg)
...
![图片](img/image_rsrc12S.jpg)

我选择了基本的 SMTP 方法（需要应用程序密码）。ChatGPT 给我提供了以下代码：

![图片](img/image_rsrc12T.jpg)
...
![图片](img/image_rsrc12Z.jpg)

继续安装依赖项，并在 Google 上搜索“Download imagenet_classes.txt”以获取文件并将其粘贴到 VS Code 中。

![图片](img/image_rsrc130.jpg)

ChatGPT 使用了几个高级计算机视觉库进行图像识别，但我们不需要了解细节。让我们直接将代码复制粘贴到 VS Code 中并运行它。

你可能会遇到以下错误：

![图片](img/image_rsrc131.jpg)

如 ChatGPT 所建议，尝试通过在下载模型时添加以下两行来禁用 SSL 验证：

![图片](img/image_rsrc132.jpg)

尝试运行程序并给出要识别的图像的路径。在我的情况下，我传递了这张图像：

![图片](img/image_rsrc133.jpg)![图片](img/image_rsrc134.jpg)

我们可以看到程序将图像识别为雏菊！

现在，如果我可以，并给出以下图像：

![图片](img/image_rsrc135.jpg)

它实际上错误地将其识别为海星：

![图片](img/image_rsrc136.jpg)

这可能是因为剥落的皮肤可能被误认为是海星的一条腿。因此，我们也希望程序告诉我们分配给图像的置信度百分比。所以让我们提示：

![图片](img/image_rsrc137.jpg)

复制更新的代码并再次运行。它显示它以 46.16% 的置信度将其识别为海星！![图片](img/image_rsrc138.jpg)

让我们再次尝试，但这次使用一个更清晰的香蕉图片：

![图片](img/image_rsrc139.jpg)

而这次，我们得到了一个更有信心的结果！

![图片](img/image_rsrc13A.jpg)
...
![图片](img/image_rsrc13B.jpg)

ChatGPT 建议使用 Flask 来渲染网站。我们必须创建一个包含“index.html”的“templates”文件夹，其代码如下：![图片](img/image_rsrc13C.jpg)
...
![图片](img/image_rsrc13D.jpg)

下载它并将其放置在“static”文件夹中。

最后，将主要代码复制粘贴到一个 Python 文件中并运行它：![图片](img/image_rsrc13E.jpg)

网站将在本地运行，以我的情况为例：127.0.0.1:5000

![图片](img/image_rsrc13F.jpg)

让我们看看它，完成了！我们在中心有一个漂亮的标志，并链接到我的个人 YouTube、Google 和 Gumroad 页面：![图片](img/image_rsrc13G.jpg)

## 改进我们的网站

假设我们想要改进我们的网站。让我们询问 ChatGPT，“我如何使这个网站更复杂”：

![图片](img/image_rsrc13H.jpg)

让我们尝试第一个建议来添加暗/亮模式切换：“添加一个按钮，在暗色和亮色主题之间切换，以获得更好的用户体验。”

![图片](img/image_rsrc13J.jpg)

让我们复制粘贴更新的代码，现在我们有了暗/亮模式！

![图片](img/image_rsrc13K.jpg)![图片](img/image_rsrc13M.jpg)

现在，假设我想“在不使用 Twitter API 的情况下嵌入我的最新 Twitter 帖子”：![图片](img/image_rsrc13N.jpg)

它更新了我的 index.html，并添加了一个 Twitter 小部件：

![图片](img/image_rsrc13P.jpg)

如果我们想更改页面布局以使 Twitter 小部件更宽，让我们提示 ChatGPT：![图片](img/image_rsrc13R.jpg)

复制粘贴更新的 index.html，现在我们有了：![图片](img/image_rsrc13S.jpg)
...
PythonAnywhere.com 有一个免费计划，所以只需注册创建一个账户。它允许你部署一个免费的 Web 应用：![](img/image_rsrc13T.jpg)

登录后，你将被带到仪表板。转到“Web”：

![](img/image_rsrc13U.jpg)

添加一个新的 Web 应用：

![](img/image_rsrc13V.jpg)

由于 ChatGPT 之前指导我使用 Flask 创建 Web 应用，点击“Flask”：![](img/image_rsrc13W.jpg)

选择你的 Python 版本（如果你不确定，你可以直接选择最新版本）![](img/image_rsrc13X.jpg)

在接下来的屏幕上，我们将只使用提供的默认路径：![](img/image_rsrc13Y.jpg)

因此，你的 Web 应用现在已经设置好了：

![](img/image_rsrc13Z.jpg)

要查看你的 Web 应用，你可以点击 URL 来访问它。以我的情况为例，是“greglim.pythonanywhere.com”：![](img/image_rsrc140.jpg)

目前，它只是一个简单的 Web 应用，显示“Hello from Flask”，因为我们还没有上传任何内容。

要更改这一点，请转到“文件”并进入“mysite”文件夹：

![](img/image_rsrc141.jpg)

这是“flask_app.py”文件：

![](img/image_rsrc142.jpg)

这是一个默认文件。如果你点击它，你会看到“Hello from Flask”——这就是 PythonAnywhere 现在正在渲染的内容：![](img/image_rsrc143.jpg)

返回到“我的站点”，删除“flask_app.py”并上传我们之前为我们的网站创建的 Python 文件。以我的情况为例：“page.py”![](img/image_rsrc144.jpg)

记住，在我们的“我的站点”文件夹中，我们还需要一个“templates”和“static”文件夹。所以，在“目录”下输入“templates”并点击“新建目录”：![](img/image_rsrc145.jpg)

现在你已经进入了“templates”文件夹，你需要上传“index.html”文件：![](img/image_rsrc146.jpg)

接下来，回到“我的站点”，创建“static”文件夹并上传“logo.png”：![](img/image_rsrc147.jpg)

返回到“Web”：

![](img/image_rsrc148.jpg)

在“代码”下向下滚动，并点击“WSGI 配置文件”：

![](img/image_rsrc149.jpg)

在这里，将“flask_app”（我们删除的文件名）更改为你上传的文件名，例如‘page’

![](img/image_rsrc14A.jpg)

基本上，它是从“page.py”导入的。点击“保存”。返回到“Web”，并重新加载网页：![](img/image_rsrc14B.jpg)

点击 URL，你应该能看到你的网页！

![](img/image_rsrc14C.jpg)
...
你还可以查看“错误日志”以查看你可能会遇到的错误：![](img/image_rsrc14D.jpg)

# 第四章 - 创建 Flappy Bird 游戏

让我们探索创建多功能项目。这些项目通常更复杂，因为它们使用了多个库和函数，需要更多的组织。这并不意味着我们必须完美地组织它们，但了解代码的结构有助于我们有效地指导 ChatGPT 并避免错误。

要开始，我们将要求 ChatGPT 帮助我们创建一个 Flappy Bird 游戏：![](img/image_rsrc14E.jpg)

ChatGPT 决定使用一个名为"pygame"的库，该库是为简单游戏开发的。代码已经准备好了。它不到 100 行：![](img/image_rsrc14F.jpg)

让我们复制、粘贴并运行它。好的，它就像 Flappy Bird，而且它在滚动（联系 support@i-ducate.com 以获取本章的视频版本）：![](img/image_rsrc14G.jpg)

让我们通过添加滚动云彩来改进：

![](img/image_rsrc14H.jpg)

确保你添加一个 cloud.png，无论是从互联网下载还是让 ChatGPT 为你生成。复制粘贴并运行代码。我们现在有了滚动云彩，给鸟儿向前移动的印象。

![](img/image_rsrc14J.jpg)

.

接下来，我们为鸟儿添加可以收集的硬币：

![](img/image_rsrc14K.jpg)

复制粘贴并运行代码。现在有了可以收集的硬币：![](img/image_rsrc14M.jpg)

现在，游戏可能太难玩了。所以我给出了提示：![](img/image_rsrc14N.jpg)

复制粘贴并运行代码。现在，在游戏开始之前，我可以选择难度：.

![](img/image_rsrc14P.jpg)

ChatGPT 还解释了他们如何通过改变某些推荐值来使游戏更容易或更难：![](img/image_rsrc14R.jpg)

让我们要求 ChatGPT 创建一些音乐和音效：

![](img/image_rsrc14S.jpg)

你甚至可以要求 ChatGPT 为你提供下载链接：![](img/image_rsrc14T.jpg)

为了简化，我只是提示它实现拍打声音：![](img/image_rsrc14U.jpg)

有时，ChatGPT 可能不会给你完整的代码。你可以提示它这样做：![](img/image_rsrc14V.jpg)

接下来，让我们添加音乐：

![](img/image_rsrc14W.jpg)

在代码中，现在正在加载"music.mp3"：

![](img/image_rsrc14X.jpg)

最后，我们告诉它将黄色圆圈改为鸟儿图像：![](img/image_rsrc14Y.jpg)
...
“给我一个可以与 pdf 聊天的 python 程序”：![](img/image_rsrc15F.jpg)

我得到了一个需要安装的依赖项列表，以及一个可以与 pdf 聊天的 python 代码：![](img/image_rsrc15G.jpg)

然而，前端目前是通过终端。假设我想让前端成为一个 Web UI。我可以提示：![](img/image_rsrc15H.jpg)

我可以将其复制粘贴，并使用以下命令运行 streamlit 应用程序：

![](img/image_rsrc15J.jpg)

在过程中，您可能会遇到错误。但只需将错误复制粘贴到 ChatGPT 中，看看它是如何纠正的。例如，我得到一个空的权重错误：![](img/image_rsrc15K.jpg)

我将其复制粘贴到 ChatGPT 中，它给了我一些选项，可以将 Python 版本降级到一个更低、更兼容的版本。

![](img/image_rsrc15M.jpg)

只需按照 ChatGPT 提示的步骤操作。

在过程中，您可能会遇到更多错误，但只需复制粘贴错误，您应该很快就能得到一个可工作的应用程序。

![](img/image_rsrc15N.jpg)
