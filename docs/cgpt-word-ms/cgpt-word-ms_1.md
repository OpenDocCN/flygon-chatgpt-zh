...
[32.  色彩搭配](part0007_split_000.xhtml#a33K)
...
[65.  视觉隐喻](part0007_split_000.xhtml#a34M)
...
[98.  整合反馈](part0007_split_000.xhtml#a35N)
...
[131.  平行结构](part0007_split_001.xhtml#a36P)
...
[164.  互动审查](part0007_split_001.xhtml#a37R)
...
[197.  视觉隐喻](part0007_split_001.xhtml#a38S)
...
[230.  自动化表格任务](part0007_split_001.xhtml#a39T)
...
专业提示使用 ChatGPT 识别和增强写作中的关键要点。步骤1\. 开始 Word 文档。2\. 描述你想要强调一个要点的部分。3\. 接收强调重要信息的建议。ChatGPT 提示"帮我强调这个产品的主要优点。" |
...
专业提示：使用 ChatGPT 剔除多余细节和废话。步骤1. 打开 Word 并启动 ChatGPT。2. 描述具有多余细节的段落或部分。3. 接收简洁重述的建议。ChatGPT 提示：“帮助我从这段文字中消除多余信息。” |
...
专业提示使用ChatGPT的格式化建议自定义页码。步骤1. 打开Word并访问页码设置。2. 描述你喜欢的页码样式。3. 获取关于配置页码格式的指导。ChatGPT提示“如何使用交替的罗马数字和阿拉伯数字��式化页码？” |
...
专业提示使用ChatGPT设计视觉上吸引人的引用语。步骤1. 打开Word并描述您想要突出显示的文本作为引用语。2. 调用ChatGPT获取引用语的创意设计想法。3. 根据提供的建议格式化引用语。ChatGPT提示“设计一个在此页面上突出显示的引用语。” |
...
专业提示：制造扣人心弦的悬念以保持读者的参与度。步骤1. 启动 Word 并描述场景或情境。2. 调用 ChatGPT 寻求有影响力的悬念建议。3. 以扣人心弦的悬念结束一章或一节。ChatGPT 提示：“为这一章节提供一个引人入胜的悬念结局。” |
...
专业提示使用 ChatGPT 的帮助验证事实和信息。步骤1\. 启动 Word 并访问 ChatGPT。2\. 描述您想要核实的声明或信息。3\. 向 ChatGPT 请求准确的信息或来源以确认。ChatGPT 提示“关于气候变化影响的声明准确吗？提供来源。” |
...
Pro-Tip使用 ChatGPT 的帮助准确解释统计数据。步骤1. 打开 Word 并描述您需要解释的数据集。2. 调用 ChatGPT 协助理解和解释统计发现。3. 将解释融入到您的内容中。ChatGPT 提示：“帮助我理解这份调查数据的统计显著性。”
...
专家提示：设计具有条件显示内容的模板。步骤1\. 打开 Word 并描述显示内容的条件。2\. 请求 ChatGPT 提供设置条件内容的指导。3\. 在您的模板中添加条件元素。ChatGPT 提示：“如何根据用户偏好在我的模板中显示不同的内容？” |
...
专家建议使用 ChatGPT 的指导调整语气和形式。步骤1\. 打开 Word 并描述文本的预期语气。2\. 调用 ChatGPT 对调整语气和风格提出建议。3\. 编辑文本以符合所需的语气。ChatGPT 提示：“帮我让这封电子邮件听起来更正式、更专业。” |
...
专业提示：使用 ChatGPT 的指导进行彻底的校对。步骤1. 启动 Word 并描述需要校对的内容。2. 向 ChatGPT 寻求识别和纠正错误的建议。3. 查看和编辑文本以纠正错误。ChatGPT 提示：“指导我如何校对这篇文章中的错误。”
...
专业提示使用 ChatGPT 的洞察力分析反馈。步骤1. 启动 Word 并提供收到的文档反馈。2. 请求 ChatGPT 帮助解释反馈并推荐改进措施。3. 结合 ChatGPT 的建议进行修订。ChatGPT 提示“解释这份营销提案的审阅者反馈。” |
...
专业提示：为协作编辑实施版本控制。步骤1. 打开 Word 并描述版本控制的必要性。2. 向 ChatGPT 寻求设置版本控制机制的指导。3. 实施版本控制以跟踪更改和修订。ChatGPT 提示：“如何使用版本控制管理协作编辑？” |
...
Pro-Tip在ChatGPT的帮助下打造引人注目的电梯演讲。步骤1. 打开Word并提供您的企业或想法的简要概述。2. 寻求ChatGPT帮助用简洁而有影响力的语言完善电梯演讲。3. 编辑演讲，使其简洁而具信息性。ChatGPT提示“帮我为我的创业公司创建一个简洁的电梯演讲。”|
...
Pro-Tip在进行演讲时增强自信。步骤1\. 启动Word并描述您在自信方面面临的挑战。2\. 请求ChatGPT提供克服紧张和展现自信的策略。3\. 在演讲过程中实施增强自信的技巧。ChatGPT提示“分享一些帮助我在向大型观众演讲时感到更自信的技巧。” |
...
Pro-Tip通过真实性和共情与观众建立联系。步骤1. 打开 Word 并描述你的演讲背景。2. 向 ChatGPT 寻求关于表达真实性和共情以建立与观众真诚连接的指导。3. 创作反映真实情感和理解的信息。ChatGPT 提示“帮助我在关于工作场所挑战的演讲中传达共情。” |

|

# 199. 多模态内容

Pro-Tip通过多媒体元素打造动态演示。步骤1. 启动 Word 并描述你想用多媒体丰富的内容。2. 请求 ChatGPT 提供建议，如何整合视频、图片或音频来增强演示。3. 创建一个通过各种媒体吸引观众的演示。ChatGPT 提示“建议一个相关的视频片段来说明我们产品的好处。” |

|

# 200. 虚拟演示

Pro-Tip增强虚拟演示，实现有效的远程沟通。步骤1. 打开 Word 并描述你在虚拟演示中面临的挑战。2. 向 ChatGPT 寻求在虚拟环境中保持参与、清晰度和互动的策略。3. 应用虚拟演示技巧以确保有效的远程沟通。ChatGPT 提示“分享如何为我们的远程团队进行引人入胜的虚拟网络研讨会的技巧。” |

|

# 201\. 创意头脑风暴

Pro-Tip使用ChatGPT的见解生成创意点子。步骤1\. 打开Word并描述您要解决的问题或挑战。2\. 调用ChatGPT协助生成新颖和创新的点子。3\. 评估和完善点子以选择最有前景的。ChatGPT提示“帮助我为即将到来的营销活动头脑风暴独特概念。” |

|

# 202\. 构思技术

Pro-Tip应用结构化构思技术解决问题。步骤1\. 启动Word并描述您要解决的问题。2\. 向ChatGPT询问构思方法，如思维导图、SWOT分析或六顶思考帽。3\. 实施选择的技术以系统地生成想法。ChatGPT提示“推荐一种构思技术，以生成改善客户满意度的解决方案。” |

|

# 203\. 根本原因分析

Pro-Tip使用ChatGPT的帮助进行根本原因分析。步骤1\. 打开Word并描述需要分析的问题。2\. 调用ChatGPT指导您进行根本原因分析，通过提出问题来揭示潜在原因。3\. 根据分析确定根本原因并制定解决方案。ChatGPT提示“帮助我确定最近项目延迟的根本原因。” |

|

# 204\. 问题陈述的细化

Pro-Tip为更清晰的问题陈述进行精炼。步骤1\. 启动Word并描述您正在解决的问题。2\. 请求ChatGPT帮助您重新表述和完善问题陈述，以确保清晰和具体性。3\. 根据ChatGPT的建议编辑问题陈述。ChatGPT提示“就与库存管理相关的这个问题陈述提出改进建议。” |

|

# 205\. 创新解决方案

Pro-Tip为挑战生成创新解决方案。步骤1\. 打开Word并提供您面临的挑战的详细信息。2\. 调用ChatGPT获取提供新视角的创意解决方案。3\. 查看并选择要实施的最创新解决方案。ChatGPT提示“提供减少供应链运营成本的独特解决方案。” |

|

# 206\. 决策制定

Pro-Tip使用ChatGPT的见解做出明智决策。步骤1\. 启动Word并描述您需要做出的决定。2\. 向ChatGPT请求分析和考虑，以帮助您做出明智决定。3\. 评估ChatGPT提出的选项并决定最佳行动方案。ChatGPT提示“帮助我决定是否投资扩大我们的产品线。” |

|

# 207\. SWOT分析

Pro-Tip执行SWOT分析以进行有效决策。步骤1\. 打开Word并描述您要分析的项目或情况。2\. 调用ChatGPT指导您进行SWOT分析（优势、劣势、机会、威胁）。3\. 分析结果以制定战略决策。ChatGPT提示“为我们的新市场进入战略进行SWOT分析。” |

|

# 208\. 克服挑战

专业提示寻找克服特定挑战的解决方案。步骤1. 启动 Word 并描述你面临的挑战。2. 请求 ChatGPT 提供克服挑战的策略和方法。3. 实施推荐的策略来解决挑战。ChatGPT 提示"分享在组织转型期间克服变革阻力的技巧。" |

|

# 209\. 解决问题的心态

专业提示通过 ChatGPT 的指导培养解决问题的心态。步骤1. 打开 Word 并表达改善解决问题能力的愿望。2. 请求 ChatGPT 提供发展积极和分析性解决问题方法的策略。3. 将推荐的心态技巧融入日常生活。ChatGPT 提示"为我的团队提供培养解决问题心态的建议。" |

|

# 210\. 创新工作流程

专业提示创新和优化与文档相关的工作流程。步骤1. 启动 Word 并描述需要改进的工作流程。2. 请求 ChatGPT 提供建议，使用创新技术简化和自动化工作流程。3. 实施建议的更改以增强工作流程效率。ChatGPT 提示"推荐创新我们的内容创建和批准工作流程的方法。" |

|

# 211\. 场景分析

专业提示为战略规划执行场景分析。步骤1. 打开 Word 并描述要分析的场景。2. 调用 ChatGPT 指导你分析不同场景及其潜在结果。3. 评估场景以做出明智的战略决策。ChatGPT 提示"分析我们产品发布的潜在场景及其影响。" |

|

# 212\. 创造性问题框架

专业提示创造性地重新构思问题，以发现新解决方案。步骤1. 启动 Word 并描述你面临的问题。2. 请求 ChatGPT 帮助你从不同角度重新构思问题陈述，以发现替代解决方案。3. 使用重新构思的视角来识别创新解决方案。ChatGPT 提示"协助重新构思这个问题，以发现客户保留的新解决方案。" |

|

# 213\. 逆向思维

专业提示利用逆向思维以不同方式解决挑战。步骤1. 打开 Word 并描述要解决的挑战。2. 请求 ChatGPT 指导你逆转假设并考虑相反的观点。3. 探索逆向思维获得的见解，找到新颖的解决方案。ChatGPT 提示"帮助我从相反的角度思考，解决这个沟通问题。" |

|

# 214\. 想法验证

专业提示使用 ChatGPT 的见解验证想法和概念。步骤1. 启动 Word 并提供要验证的想法或概念。2. 向 ChatGPT 请求反馈和考虑因素，以评估想法的可行性和潜力。3. 评估验证结果以做出明智决策。ChatGPT 提示"验证我们软件的这个新功能想法的可行性。" |

|

# 215\. 批判性思维

-   专业提示：通过 ChatGPT 的指导发展批判性思维技能。步骤1. 打开 Word 并表达提升批判性思维能力的愿望。2. 请求 ChatGPT 提供分析情况、评估证据和做出明智判断的策略，以增强批判性思维能力。3. 应用批判性思维技术有效应对挑战。ChatGPT 提示：“分享改善问题解决中批判性思维技能的技巧。”

|

# 216\. 思维导图

-   专业提示：利用思维导图来组织思路和解决方案。步骤1. 打开 Word 并描述您想要探索的问题或概念。2. 请求 ChatGPT 指导您创建一个思维导图，以可视化连接和想法。3. 创建一个帮助您理解和解决挑战的思维导图。ChatGPT 提示：“创建一个思维导图，探索我们即将推出产品的创新功能。”

|

# 217\. 创新框架

-   专业提示：应用创新框架进行系统性问题解决。步骤1. 打开 Word 并描述您正在解决的挑战或机会。2. 请求 ChatGPT 推荐使用设计思维、精益创业或 TRIZ 等框架的建议，以获得创新解决方案。3. 利用所选框架进行头脑风暴和实施想法。ChatGPT 提示：“提供使用设计思维框架改善我们用户体验的指导。”

|

# 218\. 分析用户反馈

-   专业提示：从用户反馈中提取见解以进行改进。步骤1. 打开 Word 并提供用户反馈或评论。2. 请求 ChatGPT 帮助您分析反馈并提取有价值的见解，以增强您的产品或服务。3. 根据反馈分析实施改进。ChatGPT 提示：“分析用户反馈，识别我们移动应用中需要改进的领域。”

|

# 219\. 创新解决方案

-   专业提示：探索挑战的非传统解决方案。步骤1. 打开 Word 并描述您面临的挑战。2. 请求 ChatGPT 提供超越传统方法的创新和非传统解决方案。3. 考虑实施 ChatGPT 提出的独特想法。ChatGPT 提示：“提出非传统解决方案，减少我们订阅服务中的客户流失。”

|

# 220\. 问题-解决方案映射

-   专业提示：为了清晰起见，绘制问题-解决方案关系图。步骤1. 打开 Word 并描述您想要解决的问题。2. 请求 ChatGPT 指导将潜在解决方案映射到具体问题上。3. 创建一个将问题与相关解决方案连接起来的视觉表示。ChatGPT 提示：“帮助我绘制改善员工参与度的解决方案。”

|

# 221\. 创新催化剂

Pro-Tip识别激发创新想法的催化剂。步骤1\. 打开 Word 并表达发现创造性和创新的催化剂的愿望。2\. 调用 ChatGPT 建议启发灵感的来源，如书籍、经验或能激发创新的活动。3\. 结合确定的催化剂来推动你的创造性思维。ChatGPT 提示“推荐可以激发下一个项目创新想法的活动。” |

|

# 222\. 生成假设

Pro-Tip系统性地制定假设以解决挑战。步骤1\. 启动 Word 并描述需要分析的问题或情况。2\. 询问 ChatGPT 指导你制定假设以测试潜在解决方案。3\. 将假设用作实验和问题解决的框架。ChatGPT 提示“帮助我创建假设以了解网站流量下降的原因。” |

|

# 223\. 数据驱动的见解

Pro-Tip利用数据分析获取解决方案的见解。步骤1\. 打开 Word 并提供与挑战相关的相关数据。2\. 调用 ChatGPT 协助分析数据并提取能够指导潜在解决方案的见解。3\. 基于数据驱动的见解做出决策以推动改进。ChatGPT 提示“分析客户数据以识别增强我们服务的趋势和见解。” |

|

# 224\. 拥抱变化

Pro-Tip拥抱变化和创新以持续改进。步骤1\. 启动 Word 并表达培养创新文化的愿望。2\. 询问 ChatGPT 促进接受变化、实验和适应的思维的策略。3\. 实施推荐的做法以促进组织内的创新。ChatGPT 提示“分享促进创新文化和对变化开放的技巧。” |

|

# 225\. 记录想法

Pro-Tip记录和整理生成的想法以供将来使用。步骤1\. 打开 Word 并描述你生成的想法。2\. 询问 ChatGPT 如何组织、分类和存储想法以便轻松查阅和检索。3\. 创建一个系统来捕捉和记录未来创新的想法。ChatGPT 提示“提供方法来跟踪头脑风暴会议期间生成的创意想法。” |

|

# 226\. 自动化格式

Pro-Tip利用 ChatGPT 的指导自动化格式任务。步骤1\. 打开 Word 并描述你想要自动化的格式任务。2\. 询问 ChatGPT 如何创建宏或使用自动化工具来实现所需的格式。3\. 实施 ChatGPT 提供的自动化步骤。ChatGPT 提示“帮助我自动化将标题转换为标题大小写的过程。” |

|

# 227\. 宏创建

Pro-Tip创建自定义宏以简化 Word 中的任务。步骤1\. 启动 Word 并确定要使用宏自动化的任务。2\. 请求 ChatGPT 协助编写宏的 VBA 代码。3\. 插入并测试宏以确保它执行所需的自动化。ChatGPT 提示“指导我创建一个用于从我的文档中删除额外空格的宏。” |

|

# 228\. 数据自动化

专业提示：自动化 Word 中的数据输入和操作任务。步骤1. 打开 Word 并描述您想要自动化的与数据相关的任务。2. 询问 ChatGPT 如何使用邮件合并、数据导入或 VBA 宏来自动化任务。3. 按照 ChatGPT 提供的自动化步骤进行操作。ChatGPT 提示：“自动化在信函模板中填充客户信息的过程。” |
...
专业提示：自动化在 Word 中创建模板文档的过程。步骤1. 启动 Word 并描述您想要从模板创建的文档类型。2. 寻求 ChatGPT 的建议，了解如何创建模板并自动插入可变内容。3. 创建并保存模板，并按照提供的自动化步骤进行操作。ChatGPT 提示：“为生成定制发票创建一个自动化模板。” |

|

# 230. 自动化表格任务

专业提示：自动化与 Word 文档中的表格相关的任务。步骤1. 打开 Word 并描述您想要自动化的与表格相关的任务。2. 询问 ChatGPT 如何使用 VBA 宏或其他技术来自动化表格格式、排序或计算。3. 实施 ChatGPT 提供的自动化步骤。ChatGPT 提示：“自动化销售报告表中总计的计算过程。” |
...
专业提示：使用模板和变量自动生成内容。步骤1. 启动 Word 并描述您想要生成的内容类型。2. 寻求 ChatGPT 的指导，了解如何创建带有变量占位符的模板。3. 使用自动化工具或 VBA 宏将占位符替换为实际数据。ChatGPT 提示：“帮助我为活动参与者自动生成个性化的欢迎信。” |

|

# 232. 文档组装

专业提示：使用组件自动化组装复杂文档。步骤1. 打开 Word 并描述您需要组装的文档类型。2. 询问 ChatGPT 如何创建一个系统，其中组件可以自动合并以形成完整文档。3. 根据 ChatGPT 的建议设置自动化流程。ChatGPT 提示：“创建一个自动化系统，从各个部分自动组装全面的项目报告。” |
...
专业提示：自动化批量处理多个文档的任务。步骤1. 启动 Word 并描述您需要在多个文档上执行的重复任务。2. 寻求 ChatGPT 的建议，了解如何使用自动化工具或宏来批量处理文档。3. 按照提供的步骤自动化批量处理。ChatGPT 提示：“自动化将多个 Word 文档转换为 PDF 格式的过程。” |

|

# 234. 动态文档生成

专业提示使用自动数据插入生成动态文档。步骤1. 打开 Word 并描述您想要生成的动态文档类型。2. 向 ChatGPT 寻求关于使用数据源、邮件合并或宏来将数据插入预定义区域的建议。3. 根据 ChatGPT 提供的自动数据插入过程实施。ChatGPT 提示“为研讨会参与者生成个性化证书，包括他们的姓名和完成日期。” |
...
专业提示在文档中自动插入重复内容。步骤1. 启动 Word 并识别需要重复插入的内容。2. 请求 ChatGPT 关于使用宏、自动更正条目或自动文本来自动化插入过程的建议。3. 根据 ChatGPT 的指示设置自动化。ChatGPT 提示“在所有文档中自动插入我们公司的联系信息。” |

|

# 236\. 自动摘要

专业提示自动化长篇文档摘要的过程。步骤1. 打开 Word 并描述您想要总结的文档。2. 请求 ChatGPT 关于使用自动化工具或宏生成简明摘要的建议。3. 根据 ChatGPT 的建议设置自动摘要过程。ChatGPT 提示“为这份 20 页的研究报告创建自动摘要。” |
...
专业提示自动化版本控制和文档跟踪。步骤1. 启动 Word 并表达对自动化版本控制的需求。2. 请求 ChatGPT 指导如何使用宏、文档属性或版本控制工具来跟踪更改和管理版本。3. 根据 ChatGPT 的步骤实施版本控制过程。ChatGPT 提示“为我们的项目提案自动化版本跟踪和更改历史。” |

|

# 238\. 自动编号

专业提示在文档中自动化编号和索引。步骤1. 打开 Word 并描述需要自动编号或索引的元素。2. 请求 ChatGPT 关于使用样式、字段或宏自动化编号过程的建议。3. 根据 ChatGPT 的指导设置自动编号系统。ChatGPT 提示“帮助我自动化研究论文中图表的编号。” |
...
专业提示在 Word 中自动化定期任务和提醒。步骤1. 启动 Word 并描述需要按计划执行的任务。2. 请求 ChatGPT 关于使用 VBA 宏、插件或外部工具自动化定期任务的建议。3. 根据 ChatGPT 提供的步骤设置任务计划程序。ChatGPT 提示“为我们团队的 Word 文档自动化每日备份提醒。” |

|

# 240\. 自动提醒

Pro-Tip为特定文档事件设置自动化警报。步骤1. 打开 Word 并表达对自动警报的需求。2. 询问 ChatGPT 如何使用宏、插件或外部工具根据预定义标准触发警报。3. 根据 ChatGPT 的建议配置警报。ChatGPT 提示“为跟踪文档关键部分的更改创建自动警报。” |
...
Pro-Tip自动化表单创建和数据输入任务。步骤1. 启动 Word 并描述您想要自动化的表单或数据输入流程。2. 寻求 ChatGPT 关于使用表单模板、宏或数据源连接来自动填写表单的建议。3. 根据 ChatGPT 的指导设置表单自动化流程。ChatGPT 提示“自动化客户反馈表单的创建和填写。” |

|

# 242. 目录自动化

Pro-Tip自动化目录创建和更新。步骤1. 打开 Word 并描述自动创建和维护目录的需求。2. 询问 ChatGPT 如何使用样式、字段或宏来自动生成和更新目录。3. 根据 ChatGPT 的指导设置自动化目录流程。ChatGPT 提示“为我们的长篇文档自动生成目录。” |
...
Pro-Tip自动化邮件合并流程以进行个性化沟通。步骤1. 启动 Word 并描述需要邮件合并的通信类型。2. 寻求 ChatGPT 关于使用数据源、邮件合并字段和宏来自动化邮件合并流程的指导。3. 根据 ChatGPT 提供的步骤执行自动化邮件合并。ChatGPT 提示“使用邮件合并自动向我们的订阅者发送个性化电子邮件。” |

|

# 244. 文档审阅自动化

Pro-Tip自动化文档审阅和批准工作流程。步骤1. 打开 Word 并描述您想要自动化的审阅和批准流程。2. 询问 ChatGPT 如何使用宏、插件或在线协作工具来简化审阅工作流程。3. 根据 ChatGPT 的指示设置自动化审阅流程。ChatGPT 提示“为我们的项目提案自动化审阅和批准流程。” |
...
Pro-Tip自动化 Word 文档中索引的创建。步骤1. 启动 Word 并描述您想要创建的索引类型。2. 寻求 ChatGPT 关于使用样式、字段或宏来自动创建索引的建议。3. 根据 ChatGPT 的步骤设置自动化索引生成流程。ChatGPT 提示“为我们的综合用户手册自动创建索引。” |

|

# 246. 自动参考

Pro-Tip自动插入和格式化参考文献。步骤1. 打开 Word 并描述需要插入和格式化的参考文献。2. 询问 ChatGPT 如何使用引文管理工具、宏或插件来自动化引用过程。3. 根据 ChatGPT 的指导实施自动引用过程。ChatGPT 提示“自动化以 APA 格式插入和格式化引文。” |
...
Pro-Tip为多语言沟通自动化文档翻译任务。步骤1. 启动 Word 并描述自动化文档翻译的需求。2. 寻求 ChatGPT 关于使用翻译工具、宏或在线服务来自动化翻译过程的建议。3. 根据 ChatGPT 的建议设置自动化翻译过程。ChatGPT 提示“自动化将我们的产品手册翻译成多种语言。” |

|

# 248. 自动保存和备份

Pro-Tip自动定期保存和备份 Word 文档。步骤1. 打开 Word 并表达自动保存和备份文档的需求。2. 询问 ChatGPT 如何使用宏、插件或外部工具来自动化保存和备份过程的建议。3. 根据 ChatGPT 的指导配置自动保存和备份系统。ChatGPT 提示“每小时自动保存和备份我们重要文档的过程。” |
...
Pro-Tip自动从外部来源检索相关内容。步骤1. 启动 Word 并描述需要从外部来源检索的内容。2. 寻求 ChatGPT 关于使用网络抓取工具、API 或宏来自动化内容检索过程的建议。3. 根据 ChatGPT 的建议设置自动化内容检索系统。ChatGPT 提示“自动化为我们的每周通讯检索行业新闻文章的过程。” |

|

# 250. 条件自动化

Pro-Tip根据特定条件或触发器自动化任务。步骤1. 打开 Word 并描述应触发自动化的条件或触发器。2. 询问 ChatGPT 如何使用宏、插件或 VBA 代码来创建条件自动化规则。3. 根据 ChatGPT 的指示设置条件自动化规则。ChatGPT 提示“当文档中提到特定关键词时自动插入特定内容。” |
