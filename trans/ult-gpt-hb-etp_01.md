...
# [CapabilityGPT-ChatGPT 的企业 AI 能力框架](toc.xhtml#c02)
...
# [CapabilityGPT 的概述](toc.xhtml#s18a)
...
# [CapabilityGPT 的目的](toc.xhtml#s19a)
...
# [CapabilityGPT 的优势](toc.xhtml#s20a)
...
# [CapabilityGPT 相对于技术人工智能框架的优势](toc.xhtml#s21a)
...
# [具有用例的详细 AI 能力描述](toc.xhtml#s22a)
...
[¹](#ftn1) 作为一个 AI 能力框架，CapabilityGPT 不仅限于 OpenAI 模型，还可以与其他大型语言模型一起使用，如 Anthropic 的 Claude，A21labs 的 Jurassic 或 Google 的 Bard。

[²](#ftn2) 使用 AI 能力框架的高级提示工程技术将在*[第 5 章，高级 GPT 提示工程技术](c05.xhtml)*中介绍。

[³](#ftn3) 负责任的人工智能是道德的、透明的、负责任的人工智能系统的创建和管理，强调公平、安全和偏见的减少。它寻求一个未来，人工智能尊重人权，发挥潜力而不造成伤害。

[⁴](#ftn4) GDPR 代表通用数据保护条例。这是一项全面的数据保护法律，于 2018 年 5 月 25 日生效，并适用于欧洲联盟（EU）的所有成员国。
