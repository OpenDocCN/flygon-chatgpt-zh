...
在本章中，ChatGPT 将指所有对话式 OpenAI 模型，包括 ChatGPT-3.5，ChatGPT-4 以及它们带有插件和外部工具集成的各自版本，如*[第一章](c01.xhtml)*中所述。
...
+   **AI 助手：**AI 助手是一种具有多种 AI 能力和访问外部工具或插件的高级 AI 应用程序。根据助手设计的任务，CapabilityGPT 框架中的相关能力被纳入。例如，“AI 个人秘书”可能使用能力，如创作、沟通、规划、问答、语义搜索和摘要。*[第三章](c03.xhtml)*将提供基于角色的 AI 助手示例，而*[第六章](c06.xhtml)*将涵盖功能性和协作型 AI 助手。
...
+   **增强型人工智能产品：** 这是通过添加一个或多个人工智能能力来改进的现有软件或实体产品。例如，“智能冰箱”可能会整合分类（识别物品）、预测（估计物品何时用完）和推荐（建议购物清单）。在*[第一章](c01.xhtml)*中提供了企业软件通过人工智能的增强示例。
...
ChatGPT 在其核心设计中并不原生支持语义搜索功能，但它确实支持一个开源检索插件，以便实现这种功能（有关更多详细信息，请参阅[第一章](c01.xhtml)）。GPT-3，作为前身模型，天生具备嵌入功能，使得实现语义搜索成为可能。
...
² 使用 AI 能力框架的高级提示工程技术将在*[第五章，高级 GPT 提示工程技术](c05.xhtml)*中介绍。
